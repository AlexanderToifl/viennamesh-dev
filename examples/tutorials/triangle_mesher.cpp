...
//   context.load_plugins_in_directory(VIENNAMESH_DEFAULT_PLUGIN_DIRECTORY);
  ...
  mesh_reader.set_input( "filename", "../data/box5x5_decompressed.vtu" );
//   mesh_reader.set_input( "filename", "../data/half-trigate.mesh" );
  ...
  mesher.set_input("cell_size", 1000);
  ...
  mesh_writer.set_input( "filename", "box5x5_decompressed_refined.vtu" );
  mesh_writer.run();
